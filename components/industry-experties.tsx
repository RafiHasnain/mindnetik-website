...
export const IndustryExperties = () => {
 ...
 const industryExpertise = [
  {
    ...
    description: "Transforming learning through smart, scalable digital education platforms.",
  },
  {
    name: "Healthcare & Pharmaceuticals",
    description: "Empowering patient care and operations with secure health-tech solutions.",
  },
  {
    name: "Trading & Manufacturing",
    description: "Optimizing supply chains and operations through automation and analytics.",
  },
  {
    name: "NGOs & Government Organizations",
    description: "Delivering impact-driven digital tools for public service and social good.",
  },
  {
    name: "BFSI & FinTech",
    description: "Driving financial innovation with secure, user-centric digital solutions.",
  },
  {
    name: "Real Estate, Retail & RMG",
    description: "Boosting growth and visibility with custom tech for sales, logistics, and engagement.",
  },
];
...
<section className="py-32 bg-gray-900 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-20">
        ...
        Built by industry experts to solve real-world challenges with precision, innovation, and impact
        </p>
      </div>
