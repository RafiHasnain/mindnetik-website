    ...
    <section className="py-12 py-32 bg-gradient-to-b from-gray-800 to-gray-900 relative overflow-hidden sm:py-16 lg:py-20">
      <div className="text-center mb-20">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Explore our growing suite of intelligent digital products designed to
          streamline operations, enhance decision-making, and drive business
          growth.
        </p>
      </div>
          ...
          {products.map((product, index) => (
            <div className="relative  overflow-hidden group min-h-[500px]">
              <div className="absolute inset-0 h-fit ">
                ...
                <img
                  className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125 group-hover:rotate-3"
                  src={product.image}
                  alt=""
                />
              </div>
