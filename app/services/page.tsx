import { Code, Zap, Brain, Users, Cloud, Shield, Smartphone, BarChart } from "lucide-react"
...
const ServicesPage = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Strategic guidance to navigate your digital transformation journey successfully.",
    ...
    },
    {
      ...
      features: ["Data visualization", "Business intelligence", "Real-time analytics", "Predictive modeling"],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto">
              Comprehensive technology solutions designed to accelerate your digital transformation and drive
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { step: "02", title: "Strategy", description: "Developing a comprehensive solution plan" },
